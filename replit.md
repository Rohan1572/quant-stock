...
- See the npm workspaces documentation for workspace structure and package details
- Use `npm run <command> --workspace=@workspace/<package>` to run scripts in specific packages
- Use `npm run <command> --workspaces` to run scripts across all packages (defined in root package.json)
